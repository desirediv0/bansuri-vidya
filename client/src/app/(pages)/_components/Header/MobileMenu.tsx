  ...
  return (
    ...
    >
      <div className="flex flex-col h-full px-6">
        <div className="flex justify-between items-center py-6 border-b border-[#ba1c33]">
          ...
          <button
            onClick={onClose}
            className="w-10 h-10 rounded-full bg-[#ba1c33] flex items-center justify-center text-white hover:bg-[#ba1c33] hover:scale-105 transition-all duration-300"
