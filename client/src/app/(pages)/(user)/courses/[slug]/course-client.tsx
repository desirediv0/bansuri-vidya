      ...
      <div className="bg-gradient-to-t from-[#ef5252] to-[#000000c1] text-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 py-12 md:py-16 max-w-7xl relative z-10 mt-14">
          <div className="flex flex-col md:flex-row gap-8 md:gap-12 items-center">
            ...
            {/* Video/Thumbnail */}
            <div className="relative w-full max-w-md mx-auto md:max-w-[50%] aspect-video rounded-xl overflow-hidden shadow-2xl ring-1 ring-white/20 group">
                            ...
                            <div className="flex items-center justify-center gap-2 mb-2">
                              {course.salePrice ? (
                                ...
                                <>
                                  ...
                                  <Badge
                                    variant="secondary"
                                    className="bg-red-100 text-red-700 uppercase text-xs"
                                  >
                                    Premium
                                  </Badge>
                                </>
                    ...
                    <div className="space-y-4">
                      ...
                      <ul className="space-y-3">
                        ...
                        <li className="flex items-center gap-3 p-3 rounded-lg border border-gray-100 hover:bg-gray-50 transition-colors">
                          ...
                          <div>
                            <p className="font-medium text-gray-800">
                              {course.validityDays > 0
                                ? `${course.validityDays} Days Access`
                                : "Lifetime Access"}
                            </p>
                            <p className="text-sm text-gray-600">
                              {course.validityDays > 0
                                ? "Limited time access after purchase"
